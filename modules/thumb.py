...
def register_handlers(client):
    client.on(events.NewMessage(pattern=thumb_pattern))(thumb_command)
    client.on(events.CallbackQuery(pattern=rb'^TH\|'))(thumb_resolution_cb)
    client.on(events.CallbackQuery(pattern=rb'^THX\|'))(thumb_cancel_cb)
